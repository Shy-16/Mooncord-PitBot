...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	document.querySelector("#create-banword-button").onclick = function(ev){
		...
		this.innerHTML = '<div class="spinner-border spinner-border-sm text-white" role="status"></div> Creating';
	...
	document.querySelector(".edit-banword").onclick = function(ev){
		ev.preventDefault();
...
\
			<div class="banword-options-row mt-3">\
				...
				<i class="bi bi-calendar2-x ${data['permanent_ban'] == true ? "text-success" : "text-muted"}" data-bs-toggle="tooltip" data-bs-placement="top" title="Permanent ban"></i>&emsp;\
				...
				<i class="bi bi-clock ${data['variable_time'] == true ? "text-success" : "text-muted"}" data-bs-toggle="tooltip" data-bs-placement="top" title="Variable time"></i>\
\
				<a href="" class="float-end" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">\
