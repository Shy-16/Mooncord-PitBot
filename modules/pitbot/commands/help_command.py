...
class Help(Command):
    ...
    async def dm(self, context: DMContext):
        fields = [
            {'name': 'Timeout', 'value': "You can get information regarding your current timeout by typing `remaining time`.", 'inline': False},
            {'name': 'Strikes', 'value': "You can get information regarding your current strikes by typing `strikes`.", 'inline': False},
            {'name': 'Info', 'value': "If you think that your pit was unjustified or would like to confirm any more details about it,\
    ...
    async def send_help(self, context: CommandContext) -> None:
        fields = [
            {'name': 'Help', 'value': "Do you really need help for the help command?.", 'inline': False}
        ]
